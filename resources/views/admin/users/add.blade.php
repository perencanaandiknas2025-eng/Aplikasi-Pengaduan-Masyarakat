        ...
        <div class="row">
            <div class="col-12">
                <a href="{{route('users.index')}}" class="btn-back">
                    <i class="bx bx-arrow-back"></i> Kembali Ke Daftar User
                </a>
                <br><br>
                @if ($errors->any())
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="officer_name">Nama Lengkap</label>
                                                <input class="form-control" type="text" id="officer_name" name="officer_name" value="{{old('officer_name')}}" placeholder="Masukkan nama lengkap">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                        ...
                        <div class="col-xl-4">
                            <div class="info-card">
                                ...
                                <p>Lengkapi semua field yang tersedia untuk melanjutkan proses pembuatan user baru.</p>
                                <div class="mt-3">
                                    <button name="submit" type="submit" class="btn btn-light btn-custom" value="save">
                                        <i class="bx bx-save"></i> Simpan
                                    </button>
                                    <button name="submit" type="submit" class="btn btn-light btn-custom" value="more">
                                        <i class="bx bx-plus"></i> Simpan & Tambah Lagi
                                    </button>
                                    <br>
                                    <a href="{{route('users.index')}}" class="btn btn-outline-light btn-custom mt-2">
